...
| NLI(p_contradiction) | Doc A | Doc B | Rationale |
| --- | --- | --- | --- |
| 0.83 | Alpha report | Beta brief | Opposite revenue signs in the same fiscal year. |
| 0.66 | Beta brief | Gamma memo | Different start years for the same Beta initiative. |
